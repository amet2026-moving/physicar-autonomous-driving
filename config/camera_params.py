...
LANE_WIDTH_MIN_RATIO = 0.30        # 정상 차선폭 최소 비율 (화면 너비 대비)
LANE_WIDTH_MAX_RATIO = 0.95        # 정상 차선폭 최대 비율 (화면 너비 대비)
LANE_WIDTH_ALPHA = 0.20            # 차선폭 추정값 EMA 스무딩 계수 (0~1, 클수록 최근 값 반영 큼)
